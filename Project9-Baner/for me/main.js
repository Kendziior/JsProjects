...
let indexInterval = setInterval(changeSlide, time); //trzeba przypisac ta funkcje do zmienej aby moc ja pozniej wyłaczyc , zresetowac i na nowo przypisywac wartosci , uzywamy leta aby moc przypisac nowa wartosc w to miejsce 
